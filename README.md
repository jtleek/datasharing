...
It is critical that you include the rawest form of the data that you have access to. This ensures that data provenance can be kept throughout the workflow. Here are some examples of the raw form of data:
...
2. Did not change any of the data values
