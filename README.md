...
to the analyst if there is a reason you know about that some of the data are missing. You should also not [impute](https://en.wikipedia.org/wiki/Imputation_(statistics))/make up/
